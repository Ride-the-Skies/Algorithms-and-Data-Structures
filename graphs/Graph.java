...
public interface Graph<V,E> {
	...
	Edge<V,E> getEdge(Vertex<V> u, Vertex<V> v);
	...
	Iterable<Edge<V,E>> outgoingEdges(Vertex<V> v);
	...
	Iterable<Edge<V,E>> incomingEdges(Vertex<V> v);
	...
	Edge<V,E> insertEdge(Vertex<V> u, Vertex<V> v, E x) throws IllegalArgumentException;
